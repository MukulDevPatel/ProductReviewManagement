...
class Program
{
    static void Main(string[] args)
    {
        ...
        List<ProductReview> list = new List<ProductReview>()
        {
            ...
            new ProductReview() {PoductID=16, UserID=16,Rating=3.2, Review="Fine", IsLike=true},
            new ProductReview() {PoductID=17, UserID=17,Rating=2.9, Review="Bad", IsLike=true},
            new ProductReview() {PoductID=18, UserID=18,Rating=3.3, Review="Good", IsLike=true},
            new ProductReview() {PoductID=19, UserID=19,Rating=3.2, Review="Fine", IsLike=true},
            new ProductReview() {PoductID=20, UserID=20,Rating=4.6, Review="Good", IsLike=false},
            new ProductReview() {PoductID=21, UserID=21,Rating= 4.4, Review="Good", IsLike=true},
            new ProductReview() {PoductID=22, UserID=22,Rating=3.9, Review="Fine", IsLike=false},
            new ProductReview() {PoductID=23, UserID=23,Rating=4.2, Review="Good", IsLike=true},
            new ProductReview() {PoductID=24, UserID=24,Rating=1.5, Review="Worst", IsLike=true},
            new ProductReview() {PoductID=25, UserID=25,Rating=3.2, Review="Fine", IsLike=false},
        };
        ...
        while(flag)
        {
            ...
            switch(option)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    ProductManagement skipRecords = new ProductManagement();
                    skipRecords.SkipTopRecords(list);
                    break;
                case 7:
                    flag = false;
                    break;
